...
<div class="shell" style="display:grid;place-items:center;min-height:100vh;background:#f3f4f6;">
  <main class="card" style="background:white;padding:2rem 3rem;border-radius:1rem;box-shadow:0 10px 20px rgba(0,0,0,.05);text-align:center;width:min(800px,90%);">
    <h2 style="font-weight:700;margin-bottom:1.5rem;">Identify all skin cells</h2>
...
<img src="assets/saliva1.png" alt="skin cell 1">
</label>

<label class="img-choice">
<input type="checkbox" name="cell" value="assets/bucCell4.png" hidden>
<img src="assets/bucCell4.png" alt="skin cell 2">
</label>

<label class="img-choice">
<input type="checkbox" name="cell" value="assets/SkinCell1.png" hidden>
<img src="assets/SkinCell1.png" alt="skin cell 3">
</label>

<label class="img-choice">
<input type="checkbox" name="cell" value="assets/SkinCell2.png" hidden>
<img src="assets/SkinCell2.png" alt="skin cell 4">
</label>

<label class="img-choice">
<input type="checkbox" name="cell" value="assets/bucCell1.png" hidden>
<img src="assets/bucCell1.png" alt="skin cell 5">
</label>

<label class="img-choice">
<input type="checkbox" name="cell" value="assets/saliva6.png" hidden>
<img src="assets/saliva6.png" alt="skin cell 6">
</label>

</div>

<!-- Submit button -->
<button type="submit" class="btn" style="background:#d1d5db;color:#000;padding:.6rem 2rem;border-radius:2rem;border:none;cursor:pointer;font-weight:600;">
        Submit
</button>
</form>
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const correct = new Set([
    "assets/SkinCell1.png",
    "assets/SkinCell2.png"
  ]);
  ...
  let reviewed = false; // first submit = review, second = go to complete

  form.addEventListener('submit', e => {
    e.preventDefault();

    // SECOND SUBMIT → go to completion page
    if (reviewed) {
    ...
    if (selectedValues.length === 0) {
      alert('Please select at least one skin cell image.');
      return;
    }

    // Clear old review classes
    choices.forEach(choice => {
    ...
    reviewed = true; // next submit goes to complete.html
  });
});
</script>
